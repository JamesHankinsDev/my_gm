  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-5 bg-court">
      <div className="w-full max-w-sm">
        ...
        <div className="card">
          <button onClick={handleGoogle} disabled={loading} className="btn-outline w-full flex items-center justify-center gap-3 mb-4">
        ...
        <p className="text-center text-sm text-white/50 mt-6">
          ...
          <a href="/login" className="text-gold font-medium hover:underline">Sign in</a>
        </p>
      </div>
    </main>
  );
